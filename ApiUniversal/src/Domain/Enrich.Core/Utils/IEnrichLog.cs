...
namespace Enrich.Core
{
    public interface IEnrichLog
    {
        ...
        void GrayLogForDebug(Action<IEnrichLog> action);
        Task WriteLog(string JsonRequest, string JsonRespone, string Url, string RequestUrl, string RequestMethod, string StatusCode, string SalonName);
    }
}
