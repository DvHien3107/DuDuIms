...
{
    public partial class SalesLeadLogItemDto : ListItemDto
    {
        ...
        [GridField(Index = 4, ColumnName = "Type", IsDefault = true, IsShow = true, CanSort = true)]
        [SqlMapDto(SqlTables.SalesLeadComment + ".Type")]
