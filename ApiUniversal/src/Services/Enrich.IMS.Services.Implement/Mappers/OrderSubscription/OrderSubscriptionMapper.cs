...
{
    public class OrderSubscriptionMapper : BaseMapperAutoMapper<OrderSubscription, OrderSubscriptionDto>, IOrderSubscriptionMapper
    {
        public OrderSubscriptionMapper() : base()
        {
        }
    }
}
