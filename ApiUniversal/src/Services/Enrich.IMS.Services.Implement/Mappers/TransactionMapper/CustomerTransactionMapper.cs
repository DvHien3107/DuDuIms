...
{
    public class CustomerTransactionMapper : BaseMapperAutoMapper<CustomerTransaction, CustomerTransactionDto>, ICustomerTransactionMapper
    {
        public CustomerTransactionMapper() : base()
        {
        }
    }
}
