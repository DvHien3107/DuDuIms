...
namespace Enrich.Core
{
    public static partial class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            if (!pi.CanWrite)
                throw new Exception(String.Format("property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType));
        ...
        /// <summary>
        /// convert tieng viet sang tieng anh
        /// </summary>
        ...
        public static string HightLightText(this string text, string searchString, string beginTag, string endTag)
        {
            var result = text;
            text = text.Trim().ToLower();
            searchString = searchString.Trim().ToLower();
            searchString = searchString.NonUnicode();
            text = text.NonUnicode();
            if (text.Contains(searchString))
            {
                var startIndex = text.IndexOf(searchString, StringComparison.Ordinal);
                result = result.Insert(startIndex, beginTag);
                var endIndex = startIndex + searchString.Length + beginTag.Length;
                result = result.Insert(endIndex, endTag);
            }
