...
namespace Enrichcous.Payment.Mxmerchant.Api
{
    public class newOAuth
    {
        ...
        public IList<OAuth_Utilities.QueryParameter> queryParameters;
        ...
        public newOAuth(string[] endpointData, NameValueCollection tokens = null, List<OAuth_Utilities.QueryParameter> qp = null, string startDate = null, string endDate = null, string datePostedFilter = null)
        {
        ...
        public static class RequestNormalizer
        {
            ...
            public static string NormalizeRequestParameters(IList<OAuth_Utilities.QueryParameter> parameters)
            {
        ...
        public string GenerateSignatureBase(string[] endPointData)
        {
            ...
            if (endPointData[0].Contains("?")) { 
                foreach(var p in endPointData[0].Split('?')[1].Split('&'))
                {
                    ...
                    {
                        var _p = p.Split('=');
                        parameters.Add(new OAuth_Utilities.QueryParameter(_p[0], _p[1]));
                    }
            ...
            signatureBase.AppendFormat("{0}&", Utilitay.UrlEncode(endPointData[0].Split('?')[0]));
