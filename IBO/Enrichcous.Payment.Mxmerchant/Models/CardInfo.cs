...
namespace Enrichcous.Payment.Mxmerchant.Models
{
    ...
    public class card_info_response
    {
    ...
    public class MxMerchant_Customer
    {
    ...
    public class MxMerchant_payment
    {
    ...
    public class MxMerchant_payment_response
    {
        public string id { get; set; }
    ...
    public class MxMerchant_recurring
    {
    ...
    public class MxMerchant_recurring_reponse
    {
        // Root myDeserializedClass = JsonConvert.DeserializeObject<Root>(myJsonResponse); 
        public class Purchase
        {
    ...
    public class MxMerchant_recurring_payment
    {
        public long id { get; set; }
