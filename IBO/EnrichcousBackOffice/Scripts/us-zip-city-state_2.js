...
function loadUSAState2() {
    //alert($("#Country").val());


    if ($("#A_Country").val() === "United States") {

        $("#A_stateLoading").css("display", "block");
        $("#A_selectState").css("display", "block");
        $("#A_txtState").css("display", "none");
        $("#A_txtState").prop("disabled",true);
        ...
        $.ajax({
            ...
            .done(function (result) {
                $("#A_selectState").append("<option value=''> --- </option>");
                for (var i = 0; i < result.length; i++) {

                    if (result[i].ID === $("#A_txtState").val()) {
                        $("#A_selectState").append("<option selected=\"selected\"  value=\"" + result[i].ID + "\" >" + result[i].Name + "</option>");
                    }
                    else {
                        $("#A_selectState").append("<option value=\"" + result[i].ID + "\" >" + result[i].Name + "</option>");
                    }
                }
            })
            .fail(function () {
                ...
                $("#A_selectState").empty();
                $("#A_selectState").css("display", "none");
                $("#A_txtState").css("display", "block");
                $("#A_txtState").prop("disabled", false);
            })
            .always(function () { $("#A_stateLoading").css("display", "none");});
