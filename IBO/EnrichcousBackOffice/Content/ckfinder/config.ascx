...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "hothanhson";
        LicenseKey = "RNUQC45SRKG8QEQCPC6A7PK6RGHNDKQP";
        ...
        BaseDir = HttpContext.Current.Server.MapPath("/Upload/Other");
        ...
        type.MaxSize = 104857600;
        type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip", "webp", "webm" };
