 ...
 */
    ...
    var refresh_select = function (select, settings) {
        ...
        if (settings.non_selected_header && settings.selected_header) {
            ...
            non_selected_header.innerText = localStorage.getItem("non_selected_header");
            selected_header.innerText = localStorage.getItem("selected_header");
        ...
        for (var i = 0; i < select.options.length; i++) {
            ...
            if (option.selected) {
                ...
                row.className += " " + option.className;
            }
