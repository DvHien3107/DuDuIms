...
CKEDITOR.editorConfig = function( config ) {
	...
	config.filebrowserVideoUrl = '/Content/ckfinder/ckfinder.html?type=Videos';
	config.filebrowserVideoUploadUrl = '/Content/ckfinder/core/connector/aspx/connector.aspx?command=QuickUpload&type=Videos';
